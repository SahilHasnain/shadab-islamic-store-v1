...
export function ContactSection({ settings }: { settings: SiteSettings }) {
  return (
    <>
      ...
      <section className="bg-gradient-to-r from-[var(--color-page)] to-[var(--color-soft)]/40 py-16">
        <Container className="text-center">
          <h2 className="mb-6 font-display text-3xl font-bold">Ready to Order?</h2>
          <Button
      ...
      <section id="map" className="py-16">
        <Container>
          <h2 className="mb-6 text-center font-display text-3xl font-bold text-[var(--color-accent-strong)]">
            Find Us
          </h2>
